...
public class IceAspectEnchantment extends SwordEnchantment {
    ...
    private void createImprovedIceCage(Player target) {
        ...
        // Crear iglú realista con forma de domo redondeado
            ...
            for (int y = -1; y <= height; y++) {
                for (int z = -radius; z <= radius; z++) {
                    ...
                    if (shouldPlace) {
                        ...
                        // CRÍTICO: Solo colocar en espacios de aire vacíos, NO reemplazar NADA
